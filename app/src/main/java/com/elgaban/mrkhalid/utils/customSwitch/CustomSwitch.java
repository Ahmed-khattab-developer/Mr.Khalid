package com.elgaban.mrkhalid.utils.customSwitch;
...
public class CustomSwitch extends ViewGroup {
    ...
    private void init(AttributeSet attr) {
        ...
        int colorDefInactive = Color.WHITE;
        int colorDefActive = Color.BLUE;
    ...
    private int getAccentColor() {
        ...
        TypedArray a = getContext().obtainStyledAttributes(typedValue.data, new int[]{R.color.colorPrimary});
